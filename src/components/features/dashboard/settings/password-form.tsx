  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5">
        <Label className="text-xs uppercase tracking-wider text-[#5A5550]">Kata Sandi Saat Ini</Label>
        <Input type="password" name="currentPassword" required className="rounded-none border-[#E8E2D9] bg-white" />
      </div>
      <div className="space-y-1.5">
        <Label className="text-xs uppercase tracking-wider text-[#5A5550]">Kata Sandi Baru</Label>
        <Input type="password" name="newPassword" required className="rounded-none border-[#E8E2D9] bg-white" />
      </div>
      <div className="space-y-1.5">
        <Label className="text-xs uppercase tracking-wider text-[#5A5550]">Konfirmasi Kata Sandi Baru</Label>
