...
export const AnchorSection = () => {
  ...
  const { scrollYProgress: anchorScroll } = useScroll({
    target: anchorRef,
  ...
  return (
    <section
      ref={anchorRef}
      className="bg-[#F6F4F0] pt-32 pb-10 overflow-hidden flex flex-col items-center justify-center gap-2"
    >
      <FadeUp>
        <span className="text-[#8B5E56] text-[10px] tracking-[0.5em] uppercase font-heading">
          THE PREMIUM PHOTO EXPERIENCE
        </span>
      </FadeUp>
      <motion.h2
