  ...
  return (
    ...
    >
      <ParallaxElement
        direction="up"
        offset={200}
        className="absolute right-0 top-0 text-[#2C2A29]/5 font-serif text-[15rem] leading-none pointer-events-none select-none hidden lg:block overflow-visible mix-blend-multiply"
      >
        HARGA
      </ParallaxElement>
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 relative z-10">
        <div className="lg:col-span-5 h-fit lg:sticky top-40 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <FadeUp delay={0.2} className="mb-16 lg:mb-0">
            <h3 className="font-heading text-4xl md:text-5xl lg:text-5xl text-[#2C2A29] mb-8 tracking-tight">
              Investasi Momen Kita
            </h3>
