      ...
      <div className="bg-white p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-[#2C2A29]/5 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-10">
          <Image
            ...
            height={42}
            alt="HIKARA"
            className="h-8 md:h-10 w-auto mix-blend-multiply opacity-90 mb-6"
          />
          <div className="w-12 h-px bg-[#8B5E56]/30 mb-6"></div>
          <h1 className="font-heading text-2xl text-[#2C2A29] tracking-tight text-center uppercase">
            Akses Admin
          </h1>
          <p className="text-[10px] tracking-[0.3em] text-[#8B5E56] uppercase mt-2">
            Kelola Produk & Reservasi
          </p>
        </div>
        ...
        >
          <div className="space-y-2">
            <label
              htmlFor="email"
              className="text-[10px] tracking-[0.2em] uppercase font-medium text-[#5A5550]"
            >
              Email
            </label>
            <Input
            ...
            />
            {errors.email && (
              <p className="text-[10px] text-red-500 uppercase tracking-tighter mt-1">
            ...
            {isPending ? (
              <>
                <HugeiconsIcon
                  icon={Loading03Icon}
                  strokeWidth={2}
                  className="size-4 animate-spin text-[#F6F4F0]"
                />
                <span>Memproses...</span>
              </>
            ) : (
