    ...
    >
      <div className="flex items-center gap-4">
        <Link href="/">
          <Image
            ...
            width={160}
            height={48}
            alt="HIKARA Photobox Kotabaru Logo"
            className="h-10 md:h-12 w-auto mix-blend-multiply opacity-90 cursor-pointer"
          />
        </Link>
      </div>
      <div className="flex gap-4 md:gap-6 text-[10px] md:text-xs tracking-[0.2em] uppercase font-medium text-[#2C2A29]">
        <Magnetic intensity={0.1}>
          <a
            href="#about"
            className="hover:text-[#8B5E56] transition-colors hidden md:block px-2 py-1 outline-none"
          >
            Tentang Kami
          </a>
        </Magnetic>
        ...
        <Magnetic intensity={0.1}>
          <a
            href="#packages"
            className="hover:text-[#8B5E56] transition-colors px-2 py-1 outline-none"
          >
            Paket
          </a>
        </Magnetic>
