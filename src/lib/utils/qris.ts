...
const STATIC_QRIS =
  "00020101021126590013ID.CO.BNI.WWW011893600009150449128902096095344520303UMI51450015ID.OR.GPNQR.WWW0215ID10264833364460303UMI5204722153033605802ID5915HIKARA PHOTOBOX6008KOTABARU6105721136304";

export function generateDynamicQRIS(amount: number): string {
  // 1. Change Point of Initiation Method from 11 (Static) to 12 (Dynamic)
  const qris = STATIC_QRIS.replace("010211", "010212");
